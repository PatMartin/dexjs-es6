 ...
 *
 */
export function colormap(palette, presets) {
 ...
 *
 */
export function colormaps(options) {
  var opts = options || {};
  if (opts.shortlist) {
    return [
      "ECharts",
 ...
 *
 */
export function interpolateCategorical(domain, range) {
 ...
 *
 */
export function getColormap(paletteName, presets) {
